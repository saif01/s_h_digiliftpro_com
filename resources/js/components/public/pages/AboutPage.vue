                    ...
                    <v-row align="center">
                        <v-col cols="12" md="6" class="pr-md-12">
                            ...
                            <p v-else class="text-body-1 text-medium-emphasis mb-6 lh-relaxed">
                                digiliftpro helps businesses plan, build, and run modern digital systems—websites, web
                                apps, SEO improvements, email service setup, and web operations support.
                            </p>
...
export default {
    ...
    methods: {
        ...
        updateMetaTags() {
            const appName = import.meta.env.VITE_APP_NAME || 'digiliftpro';
            ...
            // Keywords
            const keywords = this.aboutData?.meta_keywords || 'about, digital agency, web development, web apps, seo, email setup, maintenance, digiliftpro';

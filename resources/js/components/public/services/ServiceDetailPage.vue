                ...
                <v-row>
                    <v-col cols="12" md="8">
                        <div class="text-body-1 text-grey-darken-3 lh-relaxed mb-8">
                            ...
                            <p v-else class="mb-6">
                                At <strong>digiliftpro</strong>, our <strong>{{ service.title }}</strong> service is
                                designed to help you achieve your goals with clear planning, production-ready delivery,

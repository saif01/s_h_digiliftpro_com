        ...
        <section
            ...
            <v-container class="position-relative z-index-2">
                <v-fade-transition appear>
                    <div>
                        <div class="glass-pill d-inline-flex align-center px-4 py-2 rounded-pill mb-3 animate-float">
                        ...
                        <h1
                            class="text-h4 text-lg-h2 font-weight-black text-white mb-2 lh-tight text-shadow-sm animate-slide-up">

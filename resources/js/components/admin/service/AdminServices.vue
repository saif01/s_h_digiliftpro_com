                        ...
                        <template v-else>
                            <tr v-for="service in services" :key="service.id">
                                ...
                                <td>
                                    ...
                                    <v-btn size="small" icon="mdi-delete" @click="deleteService(service.id)"
                                        variant="text" color="error" title="Delete Service"></v-btn>
                                </td>
                            </tr>
                ...
                <div
                    ...
                    <div v-if="pagination.last_page > 1" class="d-flex align-center gap-2">
                        <v-pagination v-model="currentPage" :length="pagination.last_page" :total-visible="7"
                            density="comfortable" @update:model-value="loadServices">
                        </v-pagination>
                    </div>
                </div>
            </v-card-text>
...
import ServiceFormDialog from './dialog/ServiceFormDialog.vue';
import ServiceDetailsDialog from './dialog/ServiceDetailsDialog.vue';
